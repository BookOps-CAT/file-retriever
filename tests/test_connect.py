...
class TestMockConnectionClient:
    ...
    def test_ConnectionClient_invalid_port(self, stub_client, stub_creds):
        (
            stub_creds["port"],
            stub_creds["remote_dir"],
            stub_creds["vendor"],
    ...
    def test_ConnectionClient_ftp_auth_error(self, client_auth_error, stub_creds):
        (
            stub_creds["port"],
            stub_creds["remote_dir"],
            stub_creds["vendor"],
    ...
    def test_ConnectionClient_sftp_auth_error(self, client_auth_error, stub_creds):
        (
            stub_creds["port"],
            stub_creds["remote_dir"],
            stub_creds["vendor"],
    ...
    def test_ConnectionClient_list_files(self, stub_client, stub_creds, port):
        (
            stub_creds["port"],
            stub_creds["remote_dir"],
            stub_creds["vendor"],
    ...
    def test_ConnectionClient_list_ftp_file_not_found(
        ...
        with pytest.raises(ftplib.error_reply):
            ConnectionClient(**stub_creds).list_files()

    def test_ConnectionClient_list_sftp_file_not_found(
    ...
    @pytest.mark.parametrize("port", [21, 22])
    def test_ConnectionClient_get_files(self, stub_client, stub_creds, port):
        (
            stub_creds["port"],
            stub_creds["remote_dir"],
            stub_creds["vendor"],
    ...
    @pytest.mark.parametrize("port", [21, 22])
    def test_ConnectionClient_get_file_not_found(
        self, client_file_error, stub_creds, port
    ):
        (
            stub_creds["port"],
            stub_creds["remote_dir"],
    ...
    def test_ConnectionClient_put_files(self, stub_client, stub_creds, port, file_dir):
        (
            stub_creds["port"],
            stub_creds["remote_dir"],
            stub_creds["vendor"],
    ...
    @pytest.mark.parametrize("port", [21, 22])
    def test_ConnectionClient_put_file_not_found(
        self, client_file_error, stub_creds, port
    ):
        (
            stub_creds["port"],
        ...
        with pytest.raises(OSError):
            ConnectionClient(**stub_creds).put_files(
                files=["foo.mrc"], src_dir="bar", dst_dir="test"
            )

    def test_ConnectionClient_put_client_error_reply(
        self, client_error_reply, stub_creds
    ):
        (
            stub_creds["port"],
